...
L.round_selected = "叛徒已被选中。"
L.round_started = "回合开始！"
L.round_restart = "本轮比赛因管理员原因被迫重新开始。"
...
L.tip10 = "作为购物角色，请记住，如果你和你的同伴表现良好，你将获得额外的装备积分奖励。确保你记得花费它们！"
...
L.tip14 = "你要狙击吗？考虑购买伪装器。如果你错过了一枪，逃到一个安全的地方，关闭伪装器，没人会知道是你在射击他们。"

L.tip15 = "如果你有传送器，它可以帮助你在被追时逃脱，并允许你快速穿越大地图。确保你总是标记了一个安全的位置。"

L.tip16 = "是否遇过无辜者群聚在一起而难以下手？请试试用收音机发出C4哔哔声或交火声，让他们分散。"

L.tip17 = "使用无线电，你可以在放置无线电后查看其放置标记来播放声音。通过按照你想要的顺序点击多个按钮来排队播放多个声音。"
...
L.tip37 = "如果回合计时器上方显示“急速模式”，则回合最初只有几分钟的时间，但每发生一次死亡，可用时间就会增加。这种模式给叛徒施加了压力，迫使他们保持行动。"
...
L.tbut_team_toggle = "[SHIFT + {walkkey} + {usekey}] 切换此按钮为 {team}"
...
L.menu_gameplay_description = "调整语音和声音音量、辅助功能设置以及游戏玩法设置。"
...
L.label_locational_voice_prep = "准备阶段启用近距离语音聊天"
...
L.beacon_marker_vision_player = "被追踪玩家"
...
L.label_roles_ragdoll_pinning = "启用布娃娃钉住"
L.magneto_stick_help_carry_rag_pin = "钉住布娃娃"
L.magneto_stick_help_carry_rag_drop = "丢下布娃娃"
L.magneto_stick_help_carry_prop_release = "释放道具"
L.magneto_stick_help_carry_prop_drop = "丢下道具"

-- 2024-01-27
L.decoy_help_primary = "安放诱饵"
L.decoy_help_secondary = "将诱饵粘贴到表面"

-- 2024-02-14
L.throw_no_room = "你在这里没有空间来扔这个设备"

-- 2024-03-04
L.use_entity = "按 [{usekey}] 使用"

-- 2024-03-06
L.submenu_gameplay_sounds_title = "客户端-声音"

L.header_sounds_settings = "UI声音设置"

L.help_enable_sound_interact = "交互声音是打开UI时播放的声音。例如，与无线电标记互动时就会播放这样的声音。"
L.help_enable_sound_buttons = "按钮声音是点击按钮时播放的点击声。"
L.help_enable_sound_message = "消息或通知声音是为聊天消息和通知播放的。它们可能相当讨厌。"

L.label_enable_sound_interact = "启用交互声音"
L.label_enable_sound_buttons = "启用按钮声音"
L.label_enable_sound_message = "启用消息声音"

L.label_level_sound_interact = "交互声音级别乘数"
L.label_level_sound_buttons = "按钮声音级别乘数"
L.label_level_sound_message = "消息声音级别乘数"

-- 2024-03-07
L.label_crosshair_static_gap_length = "启用静态准星间隙长度"
L.label_crosshair_size_gap = "准星间隙大小乘数"

-- 2024-03-31
L.help_locational_voice = "邻近聊天是TTT2实现的位置3D语音。玩家只能在围绕他们的设定半径内被听到，并且越远声音越小。"
L.help_locational_voice_prep = [[默认情况下，准备阶段禁用邻近聊天。更改此convar以在准备阶段也使用邻近聊天。

注意：回合后阶段始终禁用邻近聊天。]]
L.help_voice_duck_spectator = "压低旁观者的声音使得相比活着的玩家，其他旁观者的声音更小。如果想仔细听活着的玩家的讨论，这可能很有用。"

L.help_equipmenteditor_configurable_clip = [[可配置的大小定义了在商店购买或在世界中生成时武器的使用次数。

注意：只有启用此功能的武器才可用此设置。]]
L.label_equipmenteditor_configurable_clip = "可配置的弹夹大小"

-- 2024-04-06
L.help_locational_voice_range = [[此convar限制玩家之间可以听到对方的最大范围。它不改变音量随距离减小的方式，而是设置一个硬性截止点。

设置为0以禁用此截止。]]

-- 2024-04-07
L.help_voice_activation = [[更改激活全局语音聊天的方式。这些都使用您的'全局语音聊天'按键绑定。团队语音聊天始终为按键说话。

按键说话：按住键说话。
按键静音：您的麦克风始终开启，按住键以静音。
切换：按键切换麦克风开/关
切换（加入时激活）：像'切换'，但是加入服务器时激活麦克风。]]
...
-- 2024-04-08
L.label_inspect_credits_always = "允许所有玩家查看死者身上的积分"
L.help_inspect_credits_always = [[
当购物角色死亡时，他们的积分可以被其他具有购物角色的玩家捡起。

当此选项禁用时，只有可以捡起积分的玩家才能在尸体上看到它们。
启用时，所有玩家都可以在尸体上看到积分。]]

-- 2024-05-13
L.menu_commands_title = "管理员命令"
L.menu_commands_description = "更改地图、生成机器人和编辑玩家角色。"

L.submenu_commands_maps_title = "地图"

L.header_maps_prefixes = "通过前缀启用/禁用地图"
L.header_maps_select = "选择并更改地图"
...
L.header_commands_round_restart = "重启回合"
L.header_commands_player_slay = "杀死玩家"
L.header_commands_player_teleport = "将玩家传送至焦点位置"
L.header_commands_player_respawn = "在焦点位置复活玩家"
...
L.label_button_player_slay = "杀死玩家"
L.label_button_player_teleport = "传送玩家"
L.label_button_player_respawn = "复活玩家"
...
L.tip43 = "已确认尸体名称旁的图标显示了死者的角色。"

L.header_loadingscreen = "加载屏幕"

L.help_enable_loadingscreen = "当回合后地图刷新时会显示加载屏幕。它是为了隐藏在大地图上出现的可见和可听的延迟。它也用于显示游戏提示。"

L.label_enable_loadingscreen = "启用加载屏幕"
L.label_enable_loadingscreen_tips = "在加载屏幕上启用提示"

-- 2024-05-25
L.help_round_restart_reset = [[
重启回合或重置级别。

重启回合只是重新开始当前回合，以便你可以重新开始。重置级别清除一切，使得游戏开始新的，就像地图更改后一样新鲜。]]
